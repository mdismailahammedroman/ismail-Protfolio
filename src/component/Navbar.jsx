    ...
    >
      ...
      <nav class="w-full">
        <ul class="space-y-2 text-center">
          <Link
            to=""
            class="nav-link block border-b border-t-2 border-gray-200 py-2 border-l-6 border-r-4 hover:border-r-yellow-400 hover:border-l-yellow-400 transition active"
          >
            Home
          </Link>
          <Link
