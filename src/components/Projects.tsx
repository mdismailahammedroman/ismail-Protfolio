...
export const Projects: React.FC<ProjectsProps> = ({
  ...
  const projectsList: ProjectData[] = [
    ...
    },
    {
      ...
      description: 'SportsGear is an online platform for buying and selling sports equipment.',
      tasks: ['User authentication and authorization', 'Product catalog and search functionality', 'Shopping cart and checkout system'],
